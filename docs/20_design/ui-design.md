...
| 4 | ボット詳細・編集 | `/bots/:id` | 必要 | ボット設定の確認・編集 |
| 5 | ボット招待 | `/bots/:id/invite` | 必要 | ミーティングへのボット招待 |
| 6 | 録画一覧 | `/recordings` | 必要 | 録画リスト |
| 7 | 録画詳細 | `/recordings/:id` | 必要 | 録画再生・詳細 |
...
ランディングページ (/)
  ...
  │                                              ├── [編集] ──→ ボット詳細・編集 (/bots/:id)
  │                                              │
  │                                              ├── [招待] ──→ ボット招待 (/bots/:id/invite)
  │                                              │
  │                                              ├── [録画] ──→ 録画一覧 (/recordings)
  │                                              │               │
  │                                              │               └── [再生] ──→ 録画詳細 (/recordings/:id)
  │                                              │
  │                                              └── [設定] ──→ 設定 (/settings)
```
